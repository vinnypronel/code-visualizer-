  ...
  },
  {
    ...
    blueprintNote: {
      ...
      details: [
        ...
        "Node(int value) is the constructor that runs for new Node(...).",
...
const arrayListSteps: WalkthroughStepDef[] = [
  {
    ...
    setupNote: {
      ...
      line1Why: 'This groups the program inside a class named "ArrayListDemo". It creates no array yet.',
      line2Code: "public static void main(String[] args) {",
      line2Why: "Java begins in main and follows its statements from top to bottom.",
    },
...
const stackSteps: WalkthroughStepDef[] = [
  {
    ...
    setupNote: {
      ...
      line1Why: 'This groups the program inside "StackDemo". It does not create the data structure yet.',
      line2Code: "public static void main(String[] args) {",
      line2Why: "Java starts in main and executes its statements in order.",
    },
...
const liveTraceSteps: WalkthroughStepDef[] = [
  {
    ...
    setupNote: {
      ...
      line1Why: 'This groups the program inside a class named "Sample".',
      line2Code: "public static void main(String[] args) {",
      line2Why: "Java creates a main stack frame and begins following the statements inside main.",
    },
