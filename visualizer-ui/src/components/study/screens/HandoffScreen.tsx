...
/*
 * Final hand-off. Shows the participant ID prominently and links out to the
...
export default function HandoffScreen() {
  ...
  return (
    <StudyShell
      ...
      subheading="Thank you. Please complete the short questionnaire to finish."
    >
      <div
      ...
      <div className="flex justify-center">
        {MSFORMS_URL ? (
          ...
          >
            [PLACEHOLDER] Questionnaire link not set. Define NEXT_PUBLIC_MSFORMS_URL.
          </span>
        )}
      </div>
    </StudyShell>
