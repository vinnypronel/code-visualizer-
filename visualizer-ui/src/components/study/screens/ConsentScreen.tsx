  ...
  return (
    ...
    >
      <div className="flex flex-col lg:flex-row items-start gap-8 w-full max-w-[1440px] -ml-3 sm:-ml-6 mr-auto">
        ...
        {/* Agreement Question Section Moved Down to Bottom Level with Continue Button Farther Right */}
        <div className="flex-1 w-full min-w-[340px] flex flex-col justify-end self-stretch pb-1">
          <div className="flex flex-col xl:flex-row items-start xl:items-end justify-between gap-6 w-full">
            {/* Do You Agree Question + Yes/No Option Boxes */}
            <fieldset className="space-y-2.5 flex-1 w-full min-w-0 max-w-[480px]">
            ...
            <div className="flex flex-col items-end gap-2 flex-shrink-0 self-end xl:self-end pb-0.5 pl-2 ml-auto xl:ml-0">
              {assignError && (
